...
public class AfficherCourAdminController implements Initializable {
    @FXML
    ...
    void AfficherUnite() {
        ...
        if (selectedCour != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/AfficherUniteAdmin.fxml"));
                Parent root = loader.load();

                AfficherUniteAdminController uniteController = loader.getController();
